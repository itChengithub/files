...
import com.changgou.search.service.ContentService;
...
public class ContentController {
    ...
    public Result<List<Content>> findByCategoryId(@PathVariable("categoryId") Long categoryId){
        List<Content> contentList=contentService.findByCategoryId(categoryId);
        return new Result<List<Content>>(true,StatusCode.OK,"根据广告分类查询广告成功",contentList);
    }
