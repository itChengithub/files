...
public class SeckillGoodsServiceImpl implements SeckillGoodsService {
    ...
    @Override
    public List<SeckillGoods> findByTime(String time) {
        return redisTemplate.boundHashOps("Seckill_"+time).values();
    }

    @Override
    public SeckillGoods findByTimeAndId(String time, Long id) {
        SeckillGoods seckillGoods = (SeckillGoods) redisTemplate.boundHashOps("Seckill_"+time).get(id);
        return seckillGoods;
    }
