...
public class SpuController {
    ...
    public  Result put(@RequestBody Long[] spuIds){
        spuService.putAll(spuIds);
        return new Result(true,StatusCode.OK,"所选商品已成功上架");
    }
    @PutMapping("/put/{id}")
    ...
    public  Result pull(@PathVariable("id")Long spuId){
        ...
        return new Result(true,StatusCode.OK,"商品已成功下架");
    }
    @PutMapping("/audit/{id}")
    public  Result audit(@PathVariable("id")Long spuId){
        spuService.audit(spuId);
        return new Result(true,StatusCode.OK,"商品已成功通过审核上架");
    }
    @PutMapping("/goods")
    public Result updateSpuAndSku(@RequestBody Goods goods){
    ...
    public Result save(@RequestBody Goods goods){
        spuService.saveSkuAndParentSpu(goods);
